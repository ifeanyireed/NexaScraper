# Nigerian States and their 774 Local Government Areas (LGAs)
# This file contains the complete list of all 774 LGAs in Nigeria, organized by state.
...
NIGERIAN_LOCATIONS = {
    ...
    "Katsina": {
        ...
        "lgas": [
            ...
            "Mani", "Mashi", "Musawa", "Rimi", "Sabuwa", "Safana", "Sandamu",
            "Zango"
        ]
    },
    "Kebbi": {
    ...
    "Niger": {
        ...
        "lgas": [
            ...
            "Magama", "Mariga", "Mashegu", "Mokwa", "Muya", "Paikoro", "Rafi",
...
# Priority states/cities for initial rollout (representative of geopolitical zones)
PRIORITY_CITIES = ["Lagos", "FCT", "Kano", "Rivers", "Enugu", "Bauchi", "Oyo", "Kaduna", "Delta"]
